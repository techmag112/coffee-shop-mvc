<section>
        <div class="wrapper_main"  style="margin-left:340px">
            <div class="section_photo">
                <img src="./public/img/404.jpg" alt="Coffee Cap" class="section_girl">
            </div>
    ...
    <div class="coffee_shop">
        ...
        <div class="shop_list">
            <div class="shop_list_row"  style="margin-left:740px">
